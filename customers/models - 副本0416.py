...
class Customer(models.Model):
    ...
    '联系人', max_length=100, blank=True, null=True)
    ...
    '上次联系时间', blank=True, null=True, db_index=True)
    ...
    '创建人用户名', max_length=150, blank=True, null=True)
    created_by_name = models.CharField(
    '创建人姓名', max_length=100, blank=True, null=True)
...
class SystemSetting(models.Model):
    ...
    '公司名称', max_length=100, default='Raffinato')
...
class SearchTask(models.Model):
    ...
    STATUS_CHOICES = [('pending', '等待执行'), ('running', '执行中'),
    ...
    '执行频率', max_length=20, choices=FREQUENCY_CHOICES, blank=True)
...
class CommunicationLog(models.Model):
    CHANNEL_CHOICES = [('wechat', '微信'), ('phone', '电话'),
    ...
    '方向', max_length=20, choices=DIRECTION_CHOICES)
